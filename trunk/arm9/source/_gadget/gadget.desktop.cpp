...
_desktop::_desktop( _style&& style ) :
	_fileView( 0 , 0 , SCREEN_WIDTH , SCREEN_HEIGHT - 10 , "%USERS%/" + _system::getUser().getFoldername() + "/desktop/" , _fileViewType::symbol , false , {/* Allow All Extensions*/} , style | _style::focusNoAction )
{
