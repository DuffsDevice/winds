...
Lunar<_lua_gadget>::FunctionType _lua_gadget::methods[] = {
	...
	{ "isClickable"					, wrap( _lua_gadget , &_gadget::isClickable ) },
	{ "isResizeableX"				, wrap( _lua_gadget , &_gadget::isResizeableX ) },
	{ "isResizeableY"				, wrap( _lua_gadget , &_gadget::isResizeableY ) },
	{ "hasSmallDragTrig"			, wrap( _lua_gadget , &_gadget::hasSmallDragTrig ) },
	{ "isMouseClickRepeat"			, wrap( _lua_gadget , &_gadget::isMouseClickRepeat ) },
