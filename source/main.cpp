...
int main( int argc , char* argv[] )
{
	...
	//_system::getBuiltInProgram( "explorer.exe" )->execute({{"path","/"}});
	
	/*_scrollBar* bar = new _scrollBar( 70 , 70 , 50 , 50 , 50 , _dimension::vertical , 100 );
	_system::_gadgetHost_->addChild( bar );
	bar->setLength2( 2 );*/
	...
	//_system::_gadgetHost_->addChild( bar2 );
	//
	...
	//
	//_system::_gadgetHost_->addChild( new _textbox( 50 , 103 , 50 , "fdsgf" ) );
