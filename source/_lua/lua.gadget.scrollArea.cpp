...
//! setScrollTypeX
int _lua_scrollarea::setScrollTypeX( lua_State* L ){ ((_scrollArea*)_lua_gadget::getGadget())->setScrollTypeX( string2scrollType[ luaL_checkstring( L , 1 ) ] ); return 0; };

//! setScrollTypeY
int _lua_scrollarea::setScrollTypeY( lua_State* L ){ ((_scrollArea*)_lua_gadget::getGadget())->setScrollTypeY( string2scrollType[ luaL_checkstring( L , 1 ) ] ); return 0; }

//! setInnerWidth
int _lua_scrollarea::setCanvasWidth( lua_State* L ){ 
	((_scrollArea*)_lua_gadget::getGadget())->setCanvasWidth( luaL_optint( L , 1 , 0 ) );
	return 0;
}

//! setInnerHeight
int _lua_scrollarea::setCanvasHeight( lua_State* L ){ 
	((_scrollArea*)_lua_gadget::getGadget())->setCanvasHeight( luaL_optint( L , 1 , 0 ) );
	return 0;
}

//! scrollToX
int _lua_scrollarea::scrollToX( lua_State* L ){ ((_scrollArea*)_lua_gadget::getGadget())->scrollToX( luaL_checkint( L , 1 ) , luaL_optint( L , 2 , 1 ) ); return 0; }

//! scrollToY
int _lua_scrollarea::scrollToY( lua_State* L ){ ((_scrollArea*)_lua_gadget::getGadget())->scrollToY( luaL_checkint( L , 1 ) , luaL_optint( L , 2 , 1 ) ); return 0; }

//! scrollTo
int _lua_scrollarea::scrollTo( lua_State* L ){ ((_scrollArea*)_lua_gadget::getGadget())->scrollTo( luaL_checkint( L , 1 ) , luaL_checkint( L , 2 ) , luaL_optint( L , 3 , 1 ) ); return 0; }
