#ifndef _WIN_T_STRINGTOKENIZER_
#define _WIN_T_STRINGTOKENIZER_
...
class _stringTokenizer
{
	...
	public:
		...
		_stringTokenizer( const string& src , string& dest , const char* const delim , bool noEmptyValues = false ) :
			source( src ),
			destination( dest ),
			delimiters( delim ),
			end( 0 ),
