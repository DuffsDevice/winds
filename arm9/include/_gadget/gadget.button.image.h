...
class _imageButton : public _button {
	...
	public:
		...
		_imageButton( _optValue<_coord> x , _optValue<_coord> y , _optValue<_length> width , _optValue<_length> height , _bitmap image , _optValue<_bitmap> imagePressed = ignore , wstring title = "" , _style&& style = _style() );
};
